...
import {
  ...
  FolderKanban, FileSignature, Receipt, Activity, ListChecks, Calendar, Mail,
...
export const INTERNAL_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { section: 'follow_ups', href: '/admin/follow-ups', labelKey: 'follow_ups', icon: CalendarClock, tint: 'text-orange-400' },
