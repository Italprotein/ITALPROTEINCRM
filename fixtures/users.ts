...
export const TEAM_ACCOUNTS: UserAccount[] = [
  ...
  { id: 'u_tomasso', workspace: 'internal', role: 'super_admin', firstName: 'Tommaso', lastName: 'Pittarello', email: 'tpittarello@gmail.com', jobTitle: 'Administrator', avatarColor: '#2563eb', blurb: 'Full system access — Italprotein admin.' },
  { id: 'u_matteo', workspace: 'internal', role: 'super_admin', firstName: 'Matteo', lastName: 'Pittarello', email: 'matteo.pittarello@gmail.com', jobTitle: 'Administrator', avatarColor: '#6f8a6b', blurb: 'Full system access — Italprotein admin.' },
